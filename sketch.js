...
function createCash() {
  ...
  cash.lifetime = 150;
  cashG.add(cash);
  cash.velocityY= (4+(treasureCollection/4));
  }
}
...
function createDiamonds() {
  ...
  diamonds.velocityY= (4+(treasureCollection/4));
}
}
...
function createjewelry() {
  ...
  jewelry.velocityY= (4+(treasureCollection/4));
  }
}
...
function createSword(){
  ...
  sword.velocityY= (4+(treasureCollection/4));
  }
}
